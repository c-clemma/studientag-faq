...
\question{Muss man gut in Mathe sein?}{
    Man muss kein Mathe-Genie sein, man sollte Mathe aber auch nicht hassen. Auch wenn man nur Mathe I hat, benötigt man für die Informatik einiges an mathematischer Denkweise.
}

\question{Welche Fächer kann man mit Informatik kombinieren?}{
    Alle Fächer außer NWT. 
}
...
\question{Was ist denn der Unterschied zwischen B.Sc. und B.Ed?} {
    Im B.Ed. hört man ein paar weniger Informatikvorlesungen (insbesondere nur die Grundlagen-Vorlesungen) als im B.Sc. und hat dafür Vorlesungen zu Bildungswissenschaften und Fachdidaktik.
}
...
\question{Wie ist da so der NC?}{
    Es gibt keinen NC für das Lehramt Informatik.
}
...
\question{In welchen Klassenstufen wird Informatik unterrichtet?}{
   ...
   %     \vspace{-1em}
   % \end{figure}
   Eigentlich sieht der Bildungsplan in BW schon für die Unterstufe eine Grundbildung in der Informatik vor. 
