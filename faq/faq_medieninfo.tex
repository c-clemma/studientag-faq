...
\question{Ich kann schon Photoshop, bringt mir das bei Medieninformatik was?}{
    Bringt dir leider nichts. 
}

\question{Wie ist die Frauenquote so?}{
        Mit 34,7\% studieren mehr Frauen Medieninformatik als \glqq reine\grqq -Informatik. Es gibt aber definitiv noch Luft nach oben.  %Zahlen vom SS24
}
...
\question{Wie ist da so der NC?}{
    Im WS 23/24 gab es keinen. Das muss aber in den nächsten Jahren nicht zwingend noch so sein, der Wert ändert sich immer.
}
